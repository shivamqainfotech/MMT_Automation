package com.qait.MmtAutomation.driver;
...
/**
 * This is a static method , takes String containing Browser name to be open upon.
 * It matches the case for different browsers and act upon the match.
 * @param br
 * @return driver
 */
	public static WebDriver getDriver(String br) {
		...
		System.setProperty("webdriver.firefox.bin", "C:\\Users\\shivambharadwaj\\AppData\\Local\\Mozilla Firefox\\firefox.exe");
